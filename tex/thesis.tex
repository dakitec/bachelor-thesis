...
\input{kapitel/kapitel_3_verwandt}
\input{kapitel/kapitel_4_konzept}
\input{kapitel/kapitel_5_implementierung}
\input{kapitel/kapitel_6_test}
\input{kapitel/kapitel_7_zusammenfassung}
\input{kapitel/kapitel_8_ausblick}
% ------------------------------------------------------------------
