...
\input{kapitel/kapitel_1_einleitung}
\input{kapitel/kapitel_2_grundlagen}
\input{kapitel/kapitel_3_konzept}
\input{kapitel/kapitel_4_implementierung}
\input{kapitel/kapitel_5_test}
\input{kapitel/kapitel_6_zusammenfassung}
\input{kapitel/kapitel_7_ausblick}
% ------------------------------------------------------------------
...
\defbibfilter{literatur}{%
    type=article or type=inproceedings or type=book or type=conference
}

\defbibfilter{web}{%
    type=url or type=misc or type=book or type=conference
}
