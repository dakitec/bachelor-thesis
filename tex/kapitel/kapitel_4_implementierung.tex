...
Herms, Ruffler + ---> verlinken: Die Darstellung geschieht mit Hilfe der 3D- Bibliothek OpenInventor \autocite{inventor}
...
Wie auch bei den Vorgängern ist die Implementierung mit C++ durchgeführt. Im folgenden werden einige Unterschiede bei der Implementierung dargestellt:

- Abstrahierung der Fußkonfiguration
- Bitlogik der Füße (footPos und footConf zusammengefasst in eine FootConfiguration Klasse)
- Vereinfachung von Code-Stellen
- Anpassung aller Maße